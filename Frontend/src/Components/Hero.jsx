...
import perfilImg from '../assets/Fotos/Perfil-sin-fondo.webp'
import img1 from '../assets/Fotos/Img-ella-1.webp'
import img6 from '../assets/Fotos/Img-ella-6.webp'
                        ...
                        {images.map((img, index) => (
                            <img
                                ...
                                className={`doctor-image ${index === currentImageIndex ? 'active' : ''
                                        ...
                                        index === 1 ? 'sinfondo1-hero' : 'sinfondo2-hero'
                                    }`}
                                width="400"
                                height="500"
